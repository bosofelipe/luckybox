...
public class DozenMapper {
	...
	public static CombinationDozens toCombinationDozens(DozenDTO dto) {
		return CombinationDozens.builder().type(dto.getType()).id(dto.getId()).dozen1(dto.getDozen1())
				.dozen2(dto.getDozen2()).dozen3(dto.getDozen3()).dozen4(dto.getDozen4()).dozen5(dto.getDozen5())
				.dozen6(dto.getDozen6()).dozen7(dto.getDozen7()).dozen8(dto.getDozen8()).dozen9(dto.getDozen9())
				.dozen10(dto.getDozen10()).dozen11(dto.getDozen11()).dozen12(dto.getDozen12()).dozen13(dto.getDozen13())
				.dozen14(dto.getDozen14()).dozen15(dto.getDozen15()).dozen16(dto.getDozen16()).dozen17(dto.getDozen17())
				.dozen18(dto.getDozen18()).dozen19(dto.getDozen19()).dozen20(dto.getDozen20()).build();
	}
	...
	public static DozenDTO toDTO(CombinationDozens combination) {
		return DozenDTO.builder().id(combination.getId()).dozen1(combination.getDozen1())
				.dozen2(combination.getDozen2()).dozen3(combination.getDozen3()).dozen4(combination.getDozen4())
				.dozen5(combination.getDozen5()).dozen6(combination.getDozen6()).dozen7(combination.getDozen7())
				.dozen8(combination.getDozen8()).dozen9(combination.getDozen9()).dozen10(combination.getDozen10())
				.dozen11(combination.getDozen11()).dozen12(combination.getDozen12()).dozen13(combination.getDozen13())
				.dozen14(combination.getDozen14()).dozen15(combination.getDozen15()).dozen16(combination.getDozen16())
				.dozen17(combination.getDozen17()).dozen18(combination.getDozen18()).dozen19(combination.getDozen19())
				.dozen20(combination.getDozen20()).build();
	}
