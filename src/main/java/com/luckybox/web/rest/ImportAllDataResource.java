...
public class ImportAllDataResource {
	...
	@ApiOperation(value="Import all historic", notes="")
	@GetMapping(path = "/checkAlreadyDrawn", produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.TEXT_PLAIN_VALUE })
	...
	@ApiOperation(value="Import all historic", notes="")
	@GetMapping(path = "/fillDatasetFields", produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.TEXT_PLAIN_VALUE })
	public String fillDatasetFields() throws IOException, ZipException {
		importDataService.fillDatasetFields();
		return "Fill dataset fields OK!";
	}
	
	@ApiOperation(value="Import all historic", notes="")
	@GetMapping(path = "/generateDozenInfo", produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.TEXT_PLAIN_VALUE })
	public String generateDozenInfo() throws IOException, ZipException {
		importDataService.generateDozenInfo();
	...
	public String generateRules() throws IOException, ZipException {
		importDataService.generateRules();
